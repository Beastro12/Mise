...
const PATHS = {
  ...
  // recipe traits
  meat: "M8.5 5.5c4-1.5 9.5.5 10.5 4.5s-2 8.5-6.5 8.5-7.5-1.5-8-5 0-6.5 4-8z M11 10.5a2 2 0 1 0 4 0 2 2 0 0 0-4 0",
  chicken: "M15 4.5a4.5 4.5 0 0 1 1.5 8.7L12 17.5l-1.2 1.2a1.8 1.8 0 1 1-2.6-1.6 1.8 1.8 0 1 1 1.6-2.6l1.2-1.2 4.3-4.5A4.5 4.5 0 0 1 15 4.5z",
  fish: "M3.5 12c2.5-3.5 6.5-5 10.5-4 2 .5 3.5 2 4.5 4-1 2-2.5 3.5-4.5 4-4 1-8-.5-10.5-4z M3.5 12 1.5 9.5 M3.5 12l-2 2.5 M15 11.2v.01",
  vegetarian: "M6 18c-1-5 1-10 7-12 3-1 5-1 6-1 0 1 0 3-1 6-2 6-7 8-12 7z M6 18l7-7",
  vegan: "M12 20v-7 M12 13c0-4-3-6-7-6 0 4 3 6 7 6z M12 11c0-4 3-6.5 7-6.5 0 4-3 6.5-7 6.5z",
  quick: "M13 3 5 13.5h6L10 21l8-10.5h-6z",
  slow: "M12 7v5l3 2 M12 3.5a8.5 8.5 0 1 0 0 17 8.5 8.5 0 0 0 0-17",
  oven: "M4.5 4.5h15v15h-15z M4.5 8.5h15 M8 6.5h.01 M11 6.5h.01 M8 12h8v4.5H8z",
  soup: "M4 11h16c0 4.5-3.5 8-8 8s-8-3.5-8-8z M9 7.5c0-1.5 1-1.5 1-3 M13 7.5c0-1.5 1-1.5 1-3",
} as const;
